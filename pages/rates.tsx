          ...
          <div className="container">
            ...
            <div className={styles.all__cont}>
              <div className={styles.all__btns}>
                <div className={classNames(styles['all-btn'], 'h5', styles.active)}>
                  Оформление ИП<br />
                  и Внесения изменений
                  в ИП
                </div>
                <div className={classNames(styles['all-btn'], 'h5')}>
                  Оформление  ООО<br />
              ...
              <div className={styles.all__tabs}>
                <div className={classNames(styles.all__tab, styles.active, 'active')}>
                    ...
                    <div className={styles['all__table-row']}>
                      <div className={classNames(styles['all__table-item'], 't4')}>
                        <span className="t5">
                                    ...
                                    Добавление видов деятельности ИП
                      </div>
                      <div className={classNames(styles['all__table-item'], 't4')}>
                        <span className="t5">
                                        Стоимость <br />
                    ...
                    <div className={styles['all__table-row']}>
                      <div className={classNames(styles['all__table-item'], 't4')}>
                        <span className="t5">
                                    ...
                                    Другие изменения в ИП; напр.: смена регистрационного адреса
                      </div>
                      <div className={classNames(styles['all__table-item'], 't4')}>
                        <span className="t5">
                                        Стоимость <br />
                    ...
                    <div className={styles['all__table-row']}>
                      <div className={classNames(styles['all__table-item'], 't4')}>
                        <span className="t5">
                                    ...
                                    Доп. услуга - ИП (оформление/расширение)
                      </div>
                      <div className={classNames(styles['all__table-item'], 't4')}>
                        <span className="t5">
                                        Стоимость <br />
                    ...
                    <div className={styles['all__table-row']}>
                      <div className={classNames(styles['all__table-item'], 't4')}>
                        <span className="t5">
                                    ...
                                    Добавление видов деятельности ООО
                      </div>
                      <div className={classNames(styles['all__table-item'], 't4')}>
                        <span className="t5">
                                        Стоимость
                    ...
                    <div className={styles['all__table-row']}>
                      <div className={classNames(styles['all__table-item'], 't4')}>
                        <span className="t5">
                                    ...
                                    Другие изменения в ООО; напр.: смена юридического адреса
                      </div>
                      <div className={classNames(styles['all__table-item'], 't4')}>
                        <span className="t5">
                                        Стоимость
                    ...
                    <div className={styles['all__table-row']}>
                      <div className={classNames(styles['all__table-item'], 't4')}>
                        <span className="t5">
                                    ...
                                    Доп. услуга - ООО (оформление/расширение)
                      </div>
                      <div className={classNames(styles['all__table-item'], 't4')}>
                        <span className="t5">
                                        Стоимость
                    ...
                    <div className={styles['all__table-row']}>
                      <div className={classNames(styles['all__table-item'], 't4')}>
                        <span className="t5">
                                    ...
                                    Виртуальный адрес -<br />
                                    Базовый пакет (до 5 писем в год)
                      </div>
                      <div className={classNames(styles['all__table-item'], 't4')}>
                        <span className="t5">
                                        Описание
                        </span>
                                    Документ для записи адреса в торговый реестр и реестр предпринимателей, Маркировка почтового ящика, Фотографирование полученных писем, Учет полученной почты, E-mail уведомления о полученных письмах, Сканирование содержимого писем по запросу за доп. оплату, Ликвидация писем по запросу
                      </div>
                      <div className={classNames(styles['all__table-item'], 't4')}>
                        <span className="t5">
                          Стоимость
